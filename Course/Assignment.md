...
| 2.2 | No animation or simple back and forth type animation, use of loops, but no arrays. Some methods, but no parameters instead using global variables (or no methods). Around 100 lines of code|
